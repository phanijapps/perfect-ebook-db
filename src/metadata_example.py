#!/usr/bin/env python3
"""Example script demonstrating the use of metadata.

This script shows how to use the PageMetadata class to generate
...
def process_page(
    ...
    **additional_metadata
    ...
    """Process a single page from a PDF and generate markdown with metadata.
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Generate markdown with metadata from a PDF page")
